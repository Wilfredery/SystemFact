...
function Fila({ etiqueta, valor, fuerte = false }: { readonly etiqueta: string; readonly valor: string; readonly fuerte?: boolean }) {
  return (
...
export function Totales({ totales }: { readonly totales: TotalesVenta }) {
  return (
